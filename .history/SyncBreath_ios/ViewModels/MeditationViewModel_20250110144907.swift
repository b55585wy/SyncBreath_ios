...
class MeditationViewModel: ObservableObject {
    ...
    init(mode: MeditationType = .bambooGrove) {
        ...
        // 设置默认音效
        selectedSound = SoundOption.bambooGroveOptions.first
    }
    ...
    func switchMode(_ type: MeditationType) {
        ...
        case .bambooGrove:
            selectedSound = SoundOption.bambooGroveOptions.first
        case .cloudReturn:
            selectedSound = SoundOption.cloudReturnOptions.first
        case .starryNight:
            selectedSound = SoundOption.starryNightOptions.first
        case .mountainSpring:
            selectedSound = SoundOption.mountainSpringOptions.first
        case .zenMoment:
            selectedSound = SoundOption.zenMomentOptions.first
        case .seasonCycle:
            selectedSound = SoundOption.seasonOptions.first
        }
    }
